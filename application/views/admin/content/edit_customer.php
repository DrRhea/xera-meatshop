<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-text">Edit Pelanggan</h1>
            <p class="text-muted mt-1">Edit data pelanggan #<?php echo $customer_id; ?></p>
        </div>
    ...
    <form class="space-y-6">
        <div class="bg-card border border-border rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <textarea rows="3" 
                                  ...
                                  placeholder="Masukkan alamat lengkap">Jl. Contoh No. 123, Semarang, Jawa Tengah</textarea>
                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea rows="3" 
                                  class="w-full px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
                                  placeholder="Catatan khusus tentang pelanggan ini">Pelanggan setia sejak 2020, sering memesan daging sapi premium</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-surface rounded-lg p-6 mb-8">
                <h3 class="text-lg font-semibold text-text mb-4">Statistik Pelanggan</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-primary mb-1">Rp 2.5M</div>
                        <div class="text-sm text-muted">Total Belanja</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-primary mb-1">2020</div>
                        <div class="text-sm text-muted">Bergabung</div>
                    </div>
                </div>
            </div>
