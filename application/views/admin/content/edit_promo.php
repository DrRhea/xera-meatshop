...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Edit Promo Harian</h1>
        <p class="text-gray-600 mt-1">Edit promo harian yang sudah ada</p>
    </div>
...
<div class="bg-white rounded-lg border border-gray-200 p-6">
    <form method="POST" action="<?php echo base_url('admin/promo/edit/' . $promo->id); ?>" class="space-y-6">
                ...
                <?php if (!empty($products)): ?>
                    <?php foreach ($products as $product): ?>
                        <option value="<?php echo $product->id; ?>" 
                                ...
                                <?php echo ($product->id == $promo->product_id) ? 'selected' : ''; ?>>
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="3" 
                      ...
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"><?php echo htmlspecialchars($promo->description); ?></textarea>
        </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="original_price" id="original_price" required step="0.01" min="0"
                           value="<?php echo $promo->original_price; ?>"
                           placeholder="0"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="promo_price" id="promo_price" required step="0.01" min="0"
                           value="<?php echo $promo->promo_price; ?>"
                           placeholder="0"
                           class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                </div>
                <p class="text-sm text-gray-500 mt-1">
                    <span id="discount-display">Diskon: <?php echo $promo->discount_percentage; ?>%</span>
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="date" name="start_date" id="start_date" required 
                       value="<?php echo date('Y-m-d', strtotime($promo->start_date)); ?>"
                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
            </div>
            ...
            <div>
                ...
                <input type="date" name="end_date" id="end_date" required 
                       value="<?php echo date('Y-m-d', strtotime($promo->end_date)); ?>"
                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" min="0" 
                       value="<?php echo $promo->sort_order; ?>"
                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
            ...
            <div>
                ...
                <select name="is_active" id="is_active" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                    <option value="active" <?php echo ($promo->is_active === 'active') ? 'selected' : ''; ?>>Aktif</option>
                    <option value="inactive" <?php echo ($promo->is_active === 'inactive') ? 'selected' : ''; ?>>Tidak Aktif</option>
                </select>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    productSelect.addEventListener('change', function() {
        ...
        if (price && !originalPriceInput.value) {
