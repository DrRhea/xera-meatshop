                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        ...
                        <?php foreach ($products as $product): ?>
                            <div class="bg-white rounded-2xl transition-all duration-300 group overflow-hidden flex flex-col h-full">
                                <div class="relative h-64 bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo base_url('gambar_produk/Daging/1.jpg'); ?>" 
                                             alt="<?php echo htmlspecialchars($product->name); ?>" 
                                             class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                                    <?php endif; ?>
                                ...
                                <div class="p-6 flex flex-col h-full">
                                    <div class="flex-1">
                                        ...
                                        <?php else: ?>
                                            <p class="text-sm text-gray-600 mb-6 leading-relaxed">
                                                Daging segar berkualitas premium, dipotong dengan teknik yang tepat untuk mempertahankan kelezatan dan kelembutan.
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <div class="mt-auto">
                    ...
                    <?php else: ?>
                        ...
                        <div class="bg-white rounded-2xl transition-all duration-300 group overflow-hidden flex flex-col h-full">
                            ...
                            <div class="p-6 flex flex-col h-full">
                                <div class="flex-1">
                                    <h4 class="text-xl font-bold text-gray-900 mb-3">Daging Sapi Segar</h4>
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        <span class="px-3 py-1 border border-gray-300 rounded-full text-xs font-medium text-gray-700">Daging</span>
                                        <span class="px-3 py-1 border border-gray-300 rounded-full text-xs font-medium text-gray-700">Premium</span>
                                    </div>
                                    <p class="text-sm text-gray-600 mb-6 leading-relaxed">
                                        Daging sapi segar berkualitas premium, dipotong dengan teknik yang tepat untuk mempertahankan kelezatan dan kelembutan.
                                    </p>
                                </div>
                                <div class="mt-auto">
                                    <div class="mb-4">
                                        <span class="text-xs text-gray-500 uppercase tracking-wide">Harga</span>
                                        <div class="text-2xl font-bold text-primary">Rp 85.000/kg</div>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <button class="bg-primary text-white px-6 py-3 rounded-xl hover:bg-primary-700 transition-colors font-semibold flex-1" 
                                                onclick="sendToWhatsApp('Daging Sapi Segar', '85.000', 'Daging', 'Tersedia', 'kg')">
                                            Pesan
                                        </button>
                                        <form method="post" action="<?php echo base_url('cart/add'); ?>" class="inline">
                                            <input type="hidden" name="product_name" value="Daging Sapi Segar">
                                            <input type="hidden" name="product_price" value="85000">
                                            <input type="hidden" name="product_category" value="Daging">
