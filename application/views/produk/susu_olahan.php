                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            ...
                            <div class="bg-white rounded-2xl transition-all duration-300 group overflow-hidden flex flex-col h-full">
                                ...
                                <div class="p-6 flex flex-col h-full">
                                    <div class="flex-1">
                                        ...
                                        <?php else: ?>
                                            <p class="text-sm text-gray-600 mb-6 leading-relaxed">
                                                Susu dan olahan berkualitas premium, diproses dengan standar terbaik untuk memberikan nutrisi yang optimal bagi keluarga.
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <div class="mt-auto">
                    ...
                    <?php else: ?>
                        ...
                        <div class="bg-white rounded-2xl transition-all duration-300 group overflow-hidden flex flex-col h-full">
                            ...
                            <div class="p-6 flex flex-col h-full">
                                <div class="flex-1">
                                    <h4 class="text-xl font-bold text-gray-900 mb-3">Susu UHT Premium</h4>
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        <span class="px-3 py-1 border border-gray-300 rounded-full text-xs font-medium text-gray-700">Susu Olahan</span>
                                ...
                                <div class="mt-auto">
                                    <div class="mb-4">
                                        <span class="text-xs text-gray-500 uppercase tracking-wide">Harga</span>
                                        <div class="text-2xl font-bold text-primary">Rp 18.000/liter</div>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <button class="bg-primary text-white px-6 py-3 rounded-xl hover:bg-primary-700 transition-colors font-semibold flex-1" 
                                                onclick="sendToWhatsApp('Susu & Olahan Premium', '18.000', 'Susu & Olahan', 'Tersedia', 'liter')">
                                            Pesan
                                        </button>
                                        <form method="post" action="<?php echo base_url('cart/add'); ?>" class="inline">
                            <input type="hidden" name="product_name" value="Susu & Olahan Premium">
                            <input type="hidden" name="product_price" value="18000">
                            <input type="hidden" name="product_category" value="Susu & Olahan">
                            <input type="hidden" name="product_stock" value="Tersedia">
                            <input type="hidden" name="product_unit" value="liter">
                            <input type="hidden" name="quantity" value="1">
                            <button type="submit" class="bg-gray-100 text-gray-700 p-3 rounded-xl hover:bg-primary hover:text-white transition-colors">
                                <i class='bx bx-cart-add text-xl'></i>
                            </button>
