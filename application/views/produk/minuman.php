        ...
        <section class="py-16 bg-surface">
            <div class="w-full px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-4xl font-bold text-gray-900 mb-4 uppercase tracking-wide">Produk Minuman</h2>
                <p class="text-lg text-muted">Minuman Segar Berkualitas <span class="text-primary font-semibold">Meat Shop & Grocery</span></p>
            </div>
        </section>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            ...
                            <div class="bg-white rounded-2xl transition-all duration-300 group overflow-hidden flex flex-col h-full">
                                ...
                                <div class="p-6 flex flex-col h-full">
                                    <div class="flex-1">
                                        ...
                                        <?php else: ?>
                                            <p class="text-sm text-gray-600 mb-6 leading-relaxed">
                                                Minuman segar dengan campuran aloe vera dan delima yang menyegarkan dan menyehatkan untuk tubuh Anda.
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <div class="mt-auto">
                    ...
                    <?php else: ?>
                        ...
                        <div class="bg-white rounded-2xl transition-all duration-300 group overflow-hidden flex flex-col h-full">
                            ...
                            <div class="p-6 flex flex-col h-full">
                                <div class="flex-1">
                                    <h4 class="text-xl font-bold text-gray-900 mb-3">OKF Farmer Aloe Pomegranate 500ml</h4>
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        <span class="px-3 py-1 border border-gray-300 rounded-full text-xs font-medium text-gray-700">Minuman</span>
                                ...
                                <div class="mt-auto">
                                    <div class="mb-4">
                                        <span class="text-xs text-gray-500 uppercase tracking-wide">Harga</span>
                                        <div class="text-2xl font-bold text-primary">Rp 16.100</div>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <button class="bg-primary text-white px-6 py-3 rounded-xl hover:bg-primary-700 transition-colors font-semibold flex-1" 
                                                onclick="sendToWhatsApp('Minuman Premium', '16.100', 'Minuman', 'Tersedia', 'botol')">
                                            Pesan
                                        </button>
                                        <form method="post" action="<?php echo base_url('cart/add'); ?>" class="inline">
                            <input type="hidden" name="product_name" value="Minuman Premium">
                            <input type="hidden" name="product_price" value="16100">
